...
function getRandomNumber() {
    return String.fromCharCode(Math.floor(secureMathrandom() * 10) + 48);//(Math.random)
}
...
generateBtn.addEventListener("click", () => {
    ...
    resultEl.innerText = generatedPassword(length, hasLower, hasUpper, hasNumber, hasSymbol);
